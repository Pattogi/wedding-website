$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Logi and Patty's Wedding",

      // Event start date
      start: new Date("Jun 8, 2024 10:00"),
      ...
      end: new Date("Jun 8, 2024 23:00"),

      // Event Address
      address:
        "Abbotsbury Subtropical Gardens, Bullers Way, Abbotsbury, Weymouth, Dorset, DT3 4LA",

      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact us on.",
    },
  });
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    if (
      ...
      $.post(
        "https://script.google.com/macros/s/AKfycbzdH2UFTKf6YPTHdcVCE7KqUdbppMkZE0rb37f2j5eriefHWGBcoprzcLKt5bBVsGca/exec",
        data
      )
        .done(function (data) {
          console.log(data);
...
// Google map
function initMap() {
  var location = { lat: 50.66404107781904, lng: -2.6191163722168502 };
...
function initBBSRMap() {
  var la_fiesta = { lat: 50.66404107781904, lng: -2.6191163722168502 };
  var map = new google.maps.Map(document.getElementById("map-canvas"), {
    zoom: 15,
    center: la_fiesta,
    scrollwheel: false,
